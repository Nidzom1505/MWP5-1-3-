...
class daftarView (context: Context, attrs: AttributeSet?) : LinearLayout(context, attrs) {
    ...
    private val namaField = EditText(context).apply {
        hint = "Nama Lengkap"
    ...
    private val daftarButton = Button(context).apply {
        text = "Registrasi"
        setOnClickListener {
    ...
    init{
        ...
        addView(namaField, createLayoutParams())
        ...
        addView(daftarButton, createLayoutParams())
